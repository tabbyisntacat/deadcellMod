...
function library.createkeybindlist() -- ctrl c + ctrl v 
    ...
    function keybind_list_tbl:add_keybind(name, key)
        ...
        --
        local list_title = utility.create("Text", {Text = tostring(" ["..key.."]" .. name), Parent = key_holder, Visible = true, Transparency = 1, Theme = "Text", Size = 13, Center = false, Outline = true, Font = Drawing.Fonts.Plex, Position = UDim2.new(0,2,0,4), ZIndex = 101});
        -- functions
